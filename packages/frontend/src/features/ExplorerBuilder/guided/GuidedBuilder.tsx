...
export const GuidedBuilder = ({
  ...
  return (
    <section aria-label="Guided Explorer Builder" className="flex min-h-[38rem] flex-col gap-3">
      ...
      <div className="h-[calc(100dvh-12rem)] min-h-[38rem]">
      <section aria-labelledby="fhir-map-heading" className="relative flex h-full min-h-0 flex-col rounded-lg border bg-white p-3 shadow-sm">
      ...
      {inspectorOpen && <section aria-labelledby="fields-heading" className="fixed bottom-3 right-3 top-16 z-50 w-[min(25rem,calc(100vw-1.5rem))] overflow-y-auto rounded-xl border border-slate-200 bg-white p-4 shadow-2xl">
        ...
        </div><button type="button" aria-label="Close field inspector" className="rounded border border-slate-200 px-2 py-1 text-slate-600" onClick={() => setInspectorOpen(false)}>×</button></div>
